...
class lbank (Exchange):
    ...
    def my_parse_order(self, order, market=None):
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if type == 'market':
            ...
            order['price'] = price
        response = self.privatePostCreateOrder(self.extend(order, params),1,2,3,4,5,6,7,8,{})
        ...
        order['info'] = response
        order = self.my_parse_order(order, market)
        id = order['id']
